...
class NavigationService {
  ...
  Future<dynamic> navigateToReplace(String routeName, {dynamic argument}) {
    print('NavigationService: navigateToReplace $routeName, argument: $argument');
  ...
  Future<dynamic> navigateToAndRemoveUntil(String routeName, {dynamic argument}) {
    print('NavigationService: navigateToAndRemoveUntil $routeName, argument: $argument');
  ...
  Future<dynamic> navigateToWidgetAndRemoveUntil(Widget route) {
    print('NavigationService: navigateToWidgetAndRemoveUntil ${route.runtimeType}');
