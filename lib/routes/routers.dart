  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case addProductViewRoute:
        ...
        return MaterialPageRoute(
          builder: (_) => AddProductView(
            ...
            externalProduct: args?['externalProduct'] as Product?,
            needsImageSelection: args?['needsImageSelection'] as bool? ?? false,
          ),
        );
      ...
      case reviewScreenRoute:
        return MaterialPageRoute(
          builder: (_) => const ReviewScreen(), // Removed cartItems argument
        );
      ...
      case checkoutScannerRoute:
        return MaterialPageRoute(builder: (_) => CheckoutScannerView());
      default:
        return MaterialPageRoute(
          builder: (_) => Scaffold(
            body: Center(
