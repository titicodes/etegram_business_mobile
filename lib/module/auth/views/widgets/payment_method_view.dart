                  ...
                  children: [
                    ...
                    CustomDropDown(
                      ...
                      items: PaymentMethodType.values
                          .map((type) => type.toDisplayName())
                          .toList(),
                      value: logic.selectedPaymentType?.toDisplayName(),
                      icon: const Icon(Icons.arrow_drop_down,
                          color: Colors.grey),
                      prefix:
                      const Icon(Icons.category, color: Colors.grey),
                    ...
                    16.0.sbH,
                    AppTextField(
                      controller: logic.methodNameController,
                      onChanged: logic.updateNewMethodName,
                      hint: StringValues.paymentMethodName,
                    ...
                    16.0.sbH,
                    AppTextField(
                      controller: logic.bankController,
                      hint: 'Bank (Read-only)',
                      enabled: false,
                    ),
                    20.0.sbH,
                    ...
                    Container(
                      ...
                      alignment: Alignment.center,
                      child: TextField(
                        controller: logic.extraInfoController,
                        maxLines: 3,
                        onChanged: logic.updateExtraInfo,
                        textInputAction: TextInputAction.done,
                        onSubmitted: (_) =>
