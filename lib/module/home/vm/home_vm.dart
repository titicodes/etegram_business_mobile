...
class HomeViewModel extends BaseViewModel {
  ...
  void openDrawer() {
    if (!_mounted || scaffoldKey.currentState == null) {
      print(
          'HomeViewModel: Cannot open drawer, not mounted or scaffoldKey is null');
      return;
    }
  ...
  void closeDrawer() {
    if (!_mounted || scaffoldKey.currentState == null) {
      print(
          'HomeViewModel: Cannot close drawer, not mounted or scaffoldKey is null');
      return;
    }
  ...
  Future<void> init() async {
    ...
    try {
      ...
      if (customer != null) {
        ...
        // Verify CustomerService data
        final userId = await userService.getOwnerId();
        //final accessToken = userService.loginResponse.data?.accessToken;
