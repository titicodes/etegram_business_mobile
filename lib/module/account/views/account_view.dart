            ...
            TextButton(
              onPressed: () async {
                ...
                try {
                  ...
                  await navigationService.navigateTo(loginScreenRoute);
                } catch (e) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      try {
        ...
        if (!hasPayments) {
          ...
          await navigationService.navigateToWidget(const AddPaymentMethodView());
        }
      } catch (e) {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              NxListTile(
                onTap: () => navigationService.navigateToWidget(const ProfileView()),
                showBorder: false,
                leading: ValueListenableBuilder<String?>(
                ...
                trailing: TextButton(
                  onPressed: () => navigationService.navigateToWidget(const ProfileView()),
                  child: Row(
              ...
              NxListTile(
                onTap: () => navigationService.navigateToWidget(const NotificationView()),
                showBorder: false,
                leading: SvgPicture.asset(SvgAssets.notification),
                title: Text(
                  "Notification",
              ...
              NxListTile(
                onTap: () => navigationService.navigateToWidget(const SubscriptionView()),
                showBorder: false,
                leading: SvgPicture.asset(SvgAssets.security),
                title: Text(
                  "Subscription",
              ...
              NxListTile(
                onTap: () => navigationService.navigateToWidget(const SecurityView()),
                showBorder: false,
                leading: SvgPicture.asset(SvgAssets.security),
                title: Text(
                  "Security",
              ...
              NxListTile(
                onTap: () => navigationService.navigateToWidget(const GeneralView()),
                showBorder: false,
                leading: SvgPicture.asset(SvgAssets.settings),
                title: Text(
                  "General",
              ...
              NxListTile(
                onTap: () => navigationService.navigateToWidget(const AddPaymentMethodView()),
                showBorder: false,
                leading: SvgPicture.asset(SvgAssets.settings),
                title: Text(
                  "Payment Methods",
              ...
              NxListTile(
                onTap: () => navigationService.navigateToWidget(const Support()),
                showBorder: false,
                leading: SvgPicture.asset(SvgAssets.support),
                title: Text(
                  "Support",
