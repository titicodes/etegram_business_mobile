...
class EditExpense extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BaseView<ExpensesViewModel>(
      onModelReady: (model) {
        model.init();
        model.amountController.text = expense.amount?.toString() ?? '';
        model.descriptionController.text = expense.description ?? '';
        model.notesController.text = expense.notes ?? '';
                      ...
                      child: Column(
                        children: [
                          ...
                          CustomDropDown(
                            ...
                            value: model.category.isNotEmpty
                                ? model.category
                                : null,
                          ...
                          CustomDropDown(
                            ...
                            value: model.currency.isNotEmpty
                                ? model.currency
                                : null,
                            icon: const Icon(Icons.arrow_drop_down,
                                color: Colors.grey),
                          ...
                          CustomDropDown(
                            ...
                            value: model.paymentMethod.isNotEmpty
                                ? model.paymentMethod
                                : null,
                            icon: const Icon(Icons.arrow_drop_down,
                                color: Colors.grey),
                ...
                builder: (context, isValid, child) => AppButton(
                  ...
                  onTap: isValid
                      ? () => model.updateExpense(
                            expense.copyWith(
                              amount: double.parse(
                                  model.amountController.text.trim()),
                              description:
                              ...
                              notes:
                                  model.notesController.text.trim().isNotEmpty
